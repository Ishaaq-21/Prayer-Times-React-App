export default function ChatBotToggleBtn({
  ...
  return (
    ...
    >
      <button
        class={`      bg-gradient-to-r from-amber-500 to-orange-600 text-white p-3 rounded-full shadow-lg hover:scale-110 hover:from-amber-400 hover:to-orange-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-amber-500 focus:ring-offset-gray-900 transition-transform duration-300 ease-in-out  ${expand ? "opacity-0 invisible" : "opacity-1 visible"}`}
