...
export default function CityTime({
  ...
  return (
    <div
      ...
      className={`${activeLang == "ar" ? "sm:order-3 md:order-3 city-time font-tajawal" : "lg:order-2 font-inter"}  text-white text-3xl  2xl:text-5xl font-bold text-center  shadow-text -mt-2 sm:mt-0  `}
    >
      <p
